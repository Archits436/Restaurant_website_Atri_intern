...
class Atri:
	def __init__(self, state: Any):
		...
		self.NavbarButtons = state["NavbarButtons"]
		self.Flex4 = state["Flex4"]
		self.NavbarLinks = state["NavbarLinks"]
		self.BestBanner = state["BestBanner"]
		self.BestBannerLeft = state["BestBannerLeft"]
		self.Flex8 = state["Flex8"]
		self.OrangeBG = state["OrangeBG"]
		self.BestBurgerImage = state["BestBurgerImage"]
		self.FavouriteApps = state["FavouriteApps"]
		self.Flex10 = state["Flex10"]
		self.Flex11 = state["Flex11"]
		self.Div3 = state["Div3"]
		self.MenuContainer = state["MenuContainer"]
		self.Breakfast = state["Breakfast"]
		self.MainDishes = state["MainDishes"]
		self.Drinks = state["Drinks"]
		self.Desserts = state["Desserts"]
		self.Flex17 = state["Flex17"]
		self.AboutUsContainer = state["AboutUsContainer"]
		self.AboutUsRight = state["AboutUsRight"]
		self.Flex20 = state["Flex20"]
		self.ContactDetails = state["ContactDetails"]
		...
		self.MenuHeading = state["MenuHeading"]
		self.TextBox28 = state["TextBox28"]
		self.TextBox58 = state["TextBox58"]
		self.TextBox59 = state["TextBox59"]
		self.TextBox60 = state["TextBox60"]
		self.OrderOnlineButton = state["OrderOnlineButton"]
		self.ReservateButton = state["ReservateButton"]
		self.navbar_logo = state["navbar_logo"]
		self.HomeLink = state["HomeLink"]
		self.AboutLink = state["AboutLink"]
		self.MenuLink = state["MenuLink"]
		self.PagesLink = state["PagesLink"]
		self.CartLink = state["CartLink"]
		self.BestPlace = state["BestPlace"]
		self.BurgerLA = state["BurgerLA"]
		self.BestLorem = state["BestLorem"]
		self.BestReservate = state["BestReservate"]
		self.BestOrder = state["BestOrder"]
		self.Image3 = state["Image3"]
		self.Rappi = state["Rappi"]
		self.Grubhub = state["Grubhub"]
		self.OrderText = state["OrderText"]
		self.Postmates = state["Postmates"]
		self.DoorDash = state["DoorDash"]
		self.BrowseMenu = state["BrowseMenu"]
		self.BreakfastImage = state["BreakfastImage"]
		self.BreakfastName = state["BreakfastName"]
		self.MenuDesc1 = state["MenuDesc1"]
		self.ExploreMenu1 = state["ExploreMenu1"]
		self.DishesImage = state["DishesImage"]
		self.DishesName = state["DishesName"]
		self.MenuDesc2 = state["MenuDesc2"]
		self.ExploreMenu2 = state["ExploreMenu2"]
		self.DrinksImage = state["DrinksImage"]
		self.DrinksName = state["DrinksName"]
		self.MenuDesc3 = state["MenuDesc3"]
		self.ExploreMenu3 = state["ExploreMenu3"]
		self.DessertsImage = state["DessertsImage"]
		self.DessertsName = state["DessertsName"]
		self.MenuDesc4 = state["MenuDesc4"]
		self.ExploreMenu4 = state["ExploreMenu4"]
		self.OrderOnline = state["OrderOnline"]
		self.BookATable = state["BookATable"]
		self.Image13 = state["Image13"]
		self.AboutUsHead = state["AboutUsHead"]
		self.AboutUs1 = state["AboutUs1"]
		self.AboutUs2 = state["AboutUs2"]
		self.AboutUs = state["AboutUs"]
		self.JoinOurTeam = state["JoinOurTeam"]
		self.VisitUs = state["VisitUs"]
		self.LocationImage = state["LocationImage"]
		self.Address = state["Address"]
		self.PhoneImage = state["PhoneImage"]
		self.PhoneNo = state["PhoneNo"]
		self.EmailImage = state["EmailImage"]
	...
	def navbar(self, new_state):
		...
		global default_state
		self._navbar = Flex(new_state, default_state["navbar"])

	@property
	def NavbarButtons(self):
		self._getter_access_tracker["NavbarButtons"] = {}
		return self._NavbarButtons
	@NavbarButtons.setter
	def NavbarButtons(self, new_state):
		self._setter_access_tracker["NavbarButtons"] = {}
		global default_state
		self._NavbarButtons = Flex(new_state, default_state["NavbarButtons"])
	...
	@property
	def NavbarLinks(self):
		self._getter_access_tracker["NavbarLinks"] = {}
		return self._NavbarLinks
	@NavbarLinks.setter
	def NavbarLinks(self, new_state):
		self._setter_access_tracker["NavbarLinks"] = {}
		global default_state
		self._NavbarLinks = Flex(new_state, default_state["NavbarLinks"])

	@property
	def BestBanner(self):
		self._getter_access_tracker["BestBanner"] = {}
		return self._BestBanner
	@BestBanner.setter
	def BestBanner(self, new_state):
		self._setter_access_tracker["BestBanner"] = {}
		global default_state
		self._BestBanner = Flex(new_state, default_state["BestBanner"])

	@property
	def BestBannerLeft(self):
		self._getter_access_tracker["BestBannerLeft"] = {}
		return self._BestBannerLeft
	@BestBannerLeft.setter
	def BestBannerLeft(self, new_state):
		self._setter_access_tracker["BestBannerLeft"] = {}
		global default_state
		self._BestBannerLeft = Flex(new_state, default_state["BestBannerLeft"])
	...
	@property
	def OrangeBG(self):
		self._getter_access_tracker["OrangeBG"] = {}
		return self._OrangeBG
	@OrangeBG.setter
	def OrangeBG(self, new_state):
		self._setter_access_tracker["OrangeBG"] = {}
		global default_state
		self._OrangeBG = Flex(new_state, default_state["OrangeBG"])

	@property
	def BestBurgerImage(self):
		self._getter_access_tracker["BestBurgerImage"] = {}
		return self._BestBurgerImage
	@BestBurgerImage.setter
	def BestBurgerImage(self, new_state):
		self._setter_access_tracker["BestBurgerImage"] = {}
		global default_state
		self._BestBurgerImage = Div(new_state, default_state["BestBurgerImage"])

	@property
	def FavouriteApps(self):
		self._getter_access_tracker["FavouriteApps"] = {}
		return self._FavouriteApps
	@FavouriteApps.setter
	def FavouriteApps(self, new_state):
		self._setter_access_tracker["FavouriteApps"] = {}
		global default_state
		self._FavouriteApps = Flex(new_state, default_state["FavouriteApps"])
	...
	def MenuContainer(self):
		self._getter_access_tracker["MenuContainer"] = {}
		return self._MenuContainer
	@MenuContainer.setter
	def MenuContainer(self, new_state):
		self._setter_access_tracker["MenuContainer"] = {}
		global default_state
		self._MenuContainer = Flex(new_state, default_state["MenuContainer"])

	@property
	def Breakfast(self):
		self._getter_access_tracker["Breakfast"] = {}
		return self._Breakfast
	@Breakfast.setter
	def Breakfast(self, new_state):
		self._setter_access_tracker["Breakfast"] = {}
		global default_state
		self._Breakfast = Flex(new_state, default_state["Breakfast"])

	@property
	def MainDishes(self):
		self._getter_access_tracker["MainDishes"] = {}
		return self._MainDishes
	@MainDishes.setter
	def MainDishes(self, new_state):
		self._setter_access_tracker["MainDishes"] = {}
		global default_state
		self._MainDishes = Flex(new_state, default_state["MainDishes"])

	@property
	def Drinks(self):
		self._getter_access_tracker["Drinks"] = {}
		return self._Drinks
	@Drinks.setter
	def Drinks(self, new_state):
		self._setter_access_tracker["Drinks"] = {}
		global default_state
		self._Drinks = Flex(new_state, default_state["Drinks"])

	@property
	def Desserts(self):
		self._getter_access_tracker["Desserts"] = {}
		return self._Desserts
	@Desserts.setter
	def Desserts(self, new_state):
		self._setter_access_tracker["Desserts"] = {}
		global default_state
		self._Desserts = Flex(new_state, default_state["Desserts"])
	...
	@property
	def AboutUsContainer(self):
		self._getter_access_tracker["AboutUsContainer"] = {}
		return self._AboutUsContainer
	@AboutUsContainer.setter
	def AboutUsContainer(self, new_state):
		self._setter_access_tracker["AboutUsContainer"] = {}
		global default_state
		self._AboutUsContainer = Flex(new_state, default_state["AboutUsContainer"])

	@property
	def AboutUsRight(self):
		self._getter_access_tracker["AboutUsRight"] = {}
		return self._AboutUsRight
	@AboutUsRight.setter
	def AboutUsRight(self, new_state):
		self._setter_access_tracker["AboutUsRight"] = {}
		global default_state
		self._AboutUsRight = Flex(new_state, default_state["AboutUsRight"])
	...
	def ContactDetails(self):
		self._getter_access_tracker["ContactDetails"] = {}
		return self._ContactDetails
	@ContactDetails.setter
	def ContactDetails(self, new_state):
		self._setter_access_tracker["ContactDetails"] = {}
		global default_state
		self._ContactDetails = Flex(new_state, default_state["ContactDetails"])
	...
	@property
	def MenuHeading(self):
		self._getter_access_tracker["MenuHeading"] = {}
		return self._MenuHeading
	@MenuHeading.setter
	def MenuHeading(self, new_state):
		self._setter_access_tracker["MenuHeading"] = {}
		global default_state
		self._MenuHeading = TextBox(new_state, default_state["MenuHeading"])
	...
	@property
	def OrderOnlineButton(self):
		self._getter_access_tracker["OrderOnlineButton"] = {}
		return self._OrderOnlineButton
	@OrderOnlineButton.setter
	def OrderOnlineButton(self, new_state):
		self._setter_access_tracker["OrderOnlineButton"] = {}
		global default_state
		self._OrderOnlineButton = Button(new_state, default_state["OrderOnlineButton"])

	@property
	def ReservateButton(self):
		self._getter_access_tracker["ReservateButton"] = {}
		return self._ReservateButton
	@ReservateButton.setter
	def ReservateButton(self, new_state):
		self._setter_access_tracker["ReservateButton"] = {}
		global default_state
		self._ReservateButton = Button(new_state, default_state["ReservateButton"])

	@property
	def navbar_logo(self):
		self._getter_access_tracker["navbar_logo"] = {}
		return self._navbar_logo
	@navbar_logo.setter
	def navbar_logo(self, new_state):
		self._setter_access_tracker["navbar_logo"] = {}
		global default_state
		self._navbar_logo = Image(new_state, default_state["navbar_logo"])

	@property
	def HomeLink(self):
		self._getter_access_tracker["HomeLink"] = {}
		return self._HomeLink
	@HomeLink.setter
	def HomeLink(self, new_state):
		self._setter_access_tracker["HomeLink"] = {}
		global default_state
		self._HomeLink = Link(new_state, default_state["HomeLink"])

	@property
	def AboutLink(self):
		self._getter_access_tracker["AboutLink"] = {}
		return self._AboutLink
	@AboutLink.setter
	def AboutLink(self, new_state):
		self._setter_access_tracker["AboutLink"] = {}
		global default_state
		self._AboutLink = Link(new_state, default_state["AboutLink"])

	@property
	def MenuLink(self):
		self._getter_access_tracker["MenuLink"] = {}
		return self._MenuLink
	@MenuLink.setter
	def MenuLink(self, new_state):
		self._setter_access_tracker["MenuLink"] = {}
		global default_state
		self._MenuLink = Link(new_state, default_state["MenuLink"])

	@property
	def PagesLink(self):
		self._getter_access_tracker["PagesLink"] = {}
		return self._PagesLink
	@PagesLink.setter
	def PagesLink(self, new_state):
		self._setter_access_tracker["PagesLink"] = {}
		global default_state
		self._PagesLink = Link(new_state, default_state["PagesLink"])

	@property
	def CartLink(self):
		self._getter_access_tracker["CartLink"] = {}
		return self._CartLink
	@CartLink.setter
	def CartLink(self, new_state):
		self._setter_access_tracker["CartLink"] = {}
		global default_state
		self._CartLink = Link(new_state, default_state["CartLink"])

	@property
	def BestPlace(self):
		self._getter_access_tracker["BestPlace"] = {}
		return self._BestPlace
	@BestPlace.setter
	def BestPlace(self, new_state):
		self._setter_access_tracker["BestPlace"] = {}
		global default_state
		self._BestPlace = TextBox(new_state, default_state["BestPlace"])

	@property
	def BurgerLA(self):
		self._getter_access_tracker["BurgerLA"] = {}
		return self._BurgerLA
	@BurgerLA.setter
	def BurgerLA(self, new_state):
		self._setter_access_tracker["BurgerLA"] = {}
		global default_state
		self._BurgerLA = TextBox(new_state, default_state["BurgerLA"])

	@property
	def BestLorem(self):
		self._getter_access_tracker["BestLorem"] = {}
		return self._BestLorem
	@BestLorem.setter
	def BestLorem(self, new_state):
		self._setter_access_tracker["BestLorem"] = {}
		global default_state
		self._BestLorem = TextBox(new_state, default_state["BestLorem"])

	@property
	def BestReservate(self):
		self._getter_access_tracker["BestReservate"] = {}
		return self._BestReservate
	@BestReservate.setter
	def BestReservate(self, new_state):
		self._setter_access_tracker["BestReservate"] = {}
		global default_state
		self._BestReservate = Button(new_state, default_state["BestReservate"])

	@property
	def BestOrder(self):
		self._getter_access_tracker["BestOrder"] = {}
		return self._BestOrder
	@BestOrder.setter
	def BestOrder(self, new_state):
		self._setter_access_tracker["BestOrder"] = {}
		global default_state
		self._BestOrder = Button(new_state, default_state["BestOrder"])
	...
	@property
	def Rappi(self):
		self._getter_access_tracker["Rappi"] = {}
		return self._Rappi
	@Rappi.setter
	def Rappi(self, new_state):
		self._setter_access_tracker["Rappi"] = {}
		global default_state
		self._Rappi = Image(new_state, default_state["Rappi"])

	@property
	def Grubhub(self):
		self._getter_access_tracker["Grubhub"] = {}
		return self._Grubhub
	@Grubhub.setter
	def Grubhub(self, new_state):
		self._setter_access_tracker["Grubhub"] = {}
		global default_state
		self._Grubhub = Image(new_state, default_state["Grubhub"])

	@property
	def OrderText(self):
		self._getter_access_tracker["OrderText"] = {}
		return self._OrderText
	@OrderText.setter
	def OrderText(self, new_state):
		self._setter_access_tracker["OrderText"] = {}
		global default_state
		self._OrderText = TextBox(new_state, default_state["OrderText"])

	@property
	def Postmates(self):
		self._getter_access_tracker["Postmates"] = {}
		return self._Postmates
	@Postmates.setter
	def Postmates(self, new_state):
		self._setter_access_tracker["Postmates"] = {}
		global default_state
		self._Postmates = Image(new_state, default_state["Postmates"])

	@property
	def DoorDash(self):
		self._getter_access_tracker["DoorDash"] = {}
		return self._DoorDash
	@DoorDash.setter
	def DoorDash(self, new_state):
		self._setter_access_tracker["DoorDash"] = {}
		global default_state
		self._DoorDash = Image(new_state, default_state["DoorDash"])

	@property
	def BrowseMenu(self):
		self._getter_access_tracker["BrowseMenu"] = {}
		return self._BrowseMenu
	@BrowseMenu.setter
	def BrowseMenu(self, new_state):
		self._setter_access_tracker["BrowseMenu"] = {}
		global default_state
		self._BrowseMenu = TextBox(new_state, default_state["BrowseMenu"])

	@property
	def BreakfastImage(self):
		self._getter_access_tracker["BreakfastImage"] = {}
		return self._BreakfastImage
	@BreakfastImage.setter
	def BreakfastImage(self, new_state):
		self._setter_access_tracker["BreakfastImage"] = {}
		global default_state
		self._BreakfastImage = Image(new_state, default_state["BreakfastImage"])

	@property
	def BreakfastName(self):
		self._getter_access_tracker["BreakfastName"] = {}
		return self._BreakfastName
	@BreakfastName.setter
	def BreakfastName(self, new_state):
		self._setter_access_tracker["BreakfastName"] = {}
		global default_state
		self._BreakfastName = TextBox(new_state, default_state["BreakfastName"])

	@property
	def MenuDesc1(self):
		self._getter_access_tracker["MenuDesc1"] = {}
		return self._MenuDesc1
	@MenuDesc1.setter
	def MenuDesc1(self, new_state):
		self._setter_access_tracker["MenuDesc1"] = {}
		global default_state
		self._MenuDesc1 = TextBox(new_state, default_state["MenuDesc1"])

	@property
	def ExploreMenu1(self):
		self._getter_access_tracker["ExploreMenu1"] = {}
		return self._ExploreMenu1
	@ExploreMenu1.setter
	def ExploreMenu1(self, new_state):
		self._setter_access_tracker["ExploreMenu1"] = {}
		global default_state
		self._ExploreMenu1 = Link(new_state, default_state["ExploreMenu1"])

	@property
	def DishesImage(self):
		self._getter_access_tracker["DishesImage"] = {}
		return self._DishesImage
	@DishesImage.setter
	def DishesImage(self, new_state):
		self._setter_access_tracker["DishesImage"] = {}
		global default_state
		self._DishesImage = Image(new_state, default_state["DishesImage"])

	@property
	def DishesName(self):
		self._getter_access_tracker["DishesName"] = {}
		return self._DishesName
	@DishesName.setter
	def DishesName(self, new_state):
		self._setter_access_tracker["DishesName"] = {}
		global default_state
		self._DishesName = TextBox(new_state, default_state["DishesName"])

	@property
	def MenuDesc2(self):
		self._getter_access_tracker["MenuDesc2"] = {}
		return self._MenuDesc2
	@MenuDesc2.setter
	def MenuDesc2(self, new_state):
		self._setter_access_tracker["MenuDesc2"] = {}
		global default_state
		self._MenuDesc2 = TextBox(new_state, default_state["MenuDesc2"])

	@property
	def ExploreMenu2(self):
		self._getter_access_tracker["ExploreMenu2"] = {}
		return self._ExploreMenu2
	@ExploreMenu2.setter
	def ExploreMenu2(self, new_state):
		self._setter_access_tracker["ExploreMenu2"] = {}
		global default_state
		self._ExploreMenu2 = Link(new_state, default_state["ExploreMenu2"])

	@property
	def DrinksImage(self):
		self._getter_access_tracker["DrinksImage"] = {}
		return self._DrinksImage
	@DrinksImage.setter
	def DrinksImage(self, new_state):
		self._setter_access_tracker["DrinksImage"] = {}
		global default_state
		self._DrinksImage = Image(new_state, default_state["DrinksImage"])

	@property
	def DrinksName(self):
		self._getter_access_tracker["DrinksName"] = {}
		return self._DrinksName
	@DrinksName.setter
	def DrinksName(self, new_state):
		self._setter_access_tracker["DrinksName"] = {}
		global default_state
		self._DrinksName = TextBox(new_state, default_state["DrinksName"])

	@property
	def MenuDesc3(self):
		self._getter_access_tracker["MenuDesc3"] = {}
		return self._MenuDesc3
	@MenuDesc3.setter
	def MenuDesc3(self, new_state):
		self._setter_access_tracker["MenuDesc3"] = {}
		global default_state
		self._MenuDesc3 = TextBox(new_state, default_state["MenuDesc3"])

	@property
	def ExploreMenu3(self):
		self._getter_access_tracker["ExploreMenu3"] = {}
		return self._ExploreMenu3
	@ExploreMenu3.setter
	def ExploreMenu3(self, new_state):
		self._setter_access_tracker["ExploreMenu3"] = {}
		global default_state
		self._ExploreMenu3 = Link(new_state, default_state["ExploreMenu3"])

	@property
	def DessertsImage(self):
		self._getter_access_tracker["DessertsImage"] = {}
		return self._DessertsImage
	@DessertsImage.setter
	def DessertsImage(self, new_state):
		self._setter_access_tracker["DessertsImage"] = {}
		global default_state
		self._DessertsImage = Image(new_state, default_state["DessertsImage"])

	@property
	def DessertsName(self):
		self._getter_access_tracker["DessertsName"] = {}
		return self._DessertsName
	@DessertsName.setter
	def DessertsName(self, new_state):
		self._setter_access_tracker["DessertsName"] = {}
		global default_state
		self._DessertsName = TextBox(new_state, default_state["DessertsName"])

	@property
	def MenuDesc4(self):
		self._getter_access_tracker["MenuDesc4"] = {}
		return self._MenuDesc4
	@MenuDesc4.setter
	def MenuDesc4(self, new_state):
		self._setter_access_tracker["MenuDesc4"] = {}
		global default_state
		self._MenuDesc4 = TextBox(new_state, default_state["MenuDesc4"])

	@property
	def ExploreMenu4(self):
		self._getter_access_tracker["ExploreMenu4"] = {}
		return self._ExploreMenu4
	@ExploreMenu4.setter
	def ExploreMenu4(self, new_state):
		self._setter_access_tracker["ExploreMenu4"] = {}
		global default_state
		self._ExploreMenu4 = Link(new_state, default_state["ExploreMenu4"])

	@property
	def OrderOnline(self):
		self._getter_access_tracker["OrderOnline"] = {}
		return self._OrderOnline
	@OrderOnline.setter
	def OrderOnline(self, new_state):
		self._setter_access_tracker["OrderOnline"] = {}
		global default_state
		self._OrderOnline = Button(new_state, default_state["OrderOnline"])

	@property
	def BookATable(self):
		self._getter_access_tracker["BookATable"] = {}
		return self._BookATable
	@BookATable.setter
	def BookATable(self, new_state):
		self._setter_access_tracker["BookATable"] = {}
		global default_state
		self._BookATable = Button(new_state, default_state["BookATable"])
	...
	@property
	def AboutUsHead(self):
		self._getter_access_tracker["AboutUsHead"] = {}
		return self._AboutUsHead
	@AboutUsHead.setter
	def AboutUsHead(self, new_state):
		self._setter_access_tracker["AboutUsHead"] = {}
		global default_state
		self._AboutUsHead = TextBox(new_state, default_state["AboutUsHead"])

	@property
	def AboutUs1(self):
		self._getter_access_tracker["AboutUs1"] = {}
		return self._AboutUs1
	@AboutUs1.setter
	def AboutUs1(self, new_state):
		self._setter_access_tracker["AboutUs1"] = {}
		global default_state
		self._AboutUs1 = TextBox(new_state, default_state["AboutUs1"])

	@property
	def AboutUs2(self):
		self._getter_access_tracker["AboutUs2"] = {}
		return self._AboutUs2
	@AboutUs2.setter
	def AboutUs2(self, new_state):
		self._setter_access_tracker["AboutUs2"] = {}
		global default_state
		self._AboutUs2 = TextBox(new_state, default_state["AboutUs2"])

	@property
	def AboutUs(self):
		self._getter_access_tracker["AboutUs"] = {}
		return self._AboutUs
	@AboutUs.setter
	def AboutUs(self, new_state):
		self._setter_access_tracker["AboutUs"] = {}
		global default_state
		self._AboutUs = Button(new_state, default_state["AboutUs"])

	@property
	def JoinOurTeam(self):
		self._getter_access_tracker["JoinOurTeam"] = {}
		return self._JoinOurTeam
	@JoinOurTeam.setter
	def JoinOurTeam(self, new_state):
		self._setter_access_tracker["JoinOurTeam"] = {}
		global default_state
		self._JoinOurTeam = Button(new_state, default_state["JoinOurTeam"])

	@property
	def VisitUs(self):
		self._getter_access_tracker["VisitUs"] = {}
		return self._VisitUs
	@VisitUs.setter
	def VisitUs(self, new_state):
		self._setter_access_tracker["VisitUs"] = {}
		global default_state
		self._VisitUs = TextBox(new_state, default_state["VisitUs"])

	@property
	def LocationImage(self):
		self._getter_access_tracker["LocationImage"] = {}
		return self._LocationImage
	@LocationImage.setter
	def LocationImage(self, new_state):
		self._setter_access_tracker["LocationImage"] = {}
		global default_state
		self._LocationImage = Image(new_state, default_state["LocationImage"])

	@property
	def Address(self):
		self._getter_access_tracker["Address"] = {}
		return self._Address
	@Address.setter
	def Address(self, new_state):
		self._setter_access_tracker["Address"] = {}
		global default_state
		self._Address = TextBox(new_state, default_state["Address"])

	@property
	def PhoneImage(self):
		self._getter_access_tracker["PhoneImage"] = {}
		return self._PhoneImage
	@PhoneImage.setter
	def PhoneImage(self, new_state):
		self._setter_access_tracker["PhoneImage"] = {}
		global default_state
		self._PhoneImage = Image(new_state, default_state["PhoneImage"])

	@property
	def PhoneNo(self):
		self._getter_access_tracker["PhoneNo"] = {}
		return self._PhoneNo
	@PhoneNo.setter
	def PhoneNo(self, new_state):
		self._setter_access_tracker["PhoneNo"] = {}
		global default_state
		self._PhoneNo = TextBox(new_state, default_state["PhoneNo"])

	@property
	def EmailImage(self):
		self._getter_access_tracker["EmailImage"] = {}
		return self._EmailImage
	@EmailImage.setter
	def EmailImage(self, new_state):
		self._setter_access_tracker["EmailImage"] = {}
		global default_state
		self._EmailImage = Image(new_state, default_state["EmailImage"])

	@property
	def Email(self):
		self._getter_access_tracker["Email"] = {}
		return self._Email
	@Email.setter
	def Email(self, new_state):
		self._setter_access_tracker["Email"] = {}
		global default_state
		self._Email = TextBox(new_state, default_state["Email"])
	...
	def Price1(self, new_state):
		...
		global default_state
		self._Price1 = TextBox(new_state, default_state["Price1"])
	...
	def Price2(self, new_state):
		...
		global default_state
		self._Price2 = TextBox(new_state, default_state["Price2"])
	...
	def Price3(self, new_state):
		...
		global default_state
		self._Price3 = TextBox(new_state, default_state["Price3"])
	...
	def Price4(self, new_state):
		...
		global default_state
		self._Price4 = TextBox(new_state, default_state["Price4"])
	...
	@property
	def Price5(self):
		self._getter_access_tracker["Price5"] = {}
		return self._Price5
	@Price5.setter
	def Price5(self, new_state):
		self._setter_access_tracker["Price5"] = {}
		global default_state
		self._Price5 = TextBox(new_state, default_state["Price5"])
	...
	@property
	def Price6(self):
		self._getter_access_tracker["Price6"] = {}
		return self._Price6
	@Price6.setter
	def Price6(self, new_state):
		self._setter_access_tracker["Price6"] = {}
		global default_state
		self._Price6 = TextBox(new_state, default_state["Price6"])
	...
	@property
	def Price7(self):
		self._getter_access_tracker["Price7"] = {}
		return self._Price7
	@Price7.setter
	def Price7(self, new_state):
		self._setter_access_tracker["Price7"] = {}
		global default_state
		self._Price7 = TextBox(new_state, default_state["Price7"])
	...
	@property
	def Price8(self):
		self._getter_access_tracker["Price8"] = {}
		return self._Price8
	@Price8.setter
	def Price8(self, new_state):
		self._setter_access_tracker["Price8"] = {}
		global default_state
		self._Price8 = TextBox(new_state, default_state["Price8"])
	...
	def _to_json_fields(self):
		return {
			"navbar": self._navbar,
			"NavbarButtons": self._NavbarButtons,
			"Flex4": self._Flex4,
			"NavbarLinks": self._NavbarLinks,
			"BestBanner": self._BestBanner,
			"BestBannerLeft": self._BestBannerLeft,
			"Flex8": self._Flex8,
			"OrangeBG": self._OrangeBG,
			"BestBurgerImage": self._BestBurgerImage,
			"FavouriteApps": self._FavouriteApps,
			"Flex10": self._Flex10,
			"Flex11": self._Flex11,
			"Div3": self._Div3,
			"MenuContainer": self._MenuContainer,
			"Breakfast": self._Breakfast,
			"MainDishes": self._MainDishes,
			"Drinks": self._Drinks,
			"Desserts": self._Desserts,
			"Flex17": self._Flex17,
			"AboutUsContainer": self._AboutUsContainer,
			"AboutUsRight": self._AboutUsRight,
			"Flex20": self._Flex20,
			"ContactDetails": self._ContactDetails,
			"Flex22": self._Flex22,
			"Flex23": self._Flex23,
			"Flex24": self._Flex24,
			"Flex25": self._Flex25,
			...
			"MenuHeading": self._MenuHeading,
			"TextBox28": self._TextBox28,
			"TextBox58": self._TextBox58,
			"TextBox59": self._TextBox59,
			"TextBox60": self._TextBox60,
			"OrderOnlineButton": self._OrderOnlineButton,
			"ReservateButton": self._ReservateButton,
			"navbar_logo": self._navbar_logo,
			"HomeLink": self._HomeLink,
			"AboutLink": self._AboutLink,
			"MenuLink": self._MenuLink,
			"PagesLink": self._PagesLink,
			"CartLink": self._CartLink,
			"BestPlace": self._BestPlace,
			"BurgerLA": self._BurgerLA,
			"BestLorem": self._BestLorem,
			"BestReservate": self._BestReservate,
			"BestOrder": self._BestOrder,
			"Image3": self._Image3,
			"Rappi": self._Rappi,
			"Grubhub": self._Grubhub,
			"OrderText": self._OrderText,
			"Postmates": self._Postmates,
			"DoorDash": self._DoorDash,
			"BrowseMenu": self._BrowseMenu,
			"BreakfastImage": self._BreakfastImage,
			"BreakfastName": self._BreakfastName,
			"MenuDesc1": self._MenuDesc1,
			"ExploreMenu1": self._ExploreMenu1,
			"DishesImage": self._DishesImage,
			"DishesName": self._DishesName,
			"MenuDesc2": self._MenuDesc2,
			"ExploreMenu2": self._ExploreMenu2,
			"DrinksImage": self._DrinksImage,
			"DrinksName": self._DrinksName,
			"MenuDesc3": self._MenuDesc3,
			"ExploreMenu3": self._ExploreMenu3,
			"DessertsImage": self._DessertsImage,
			"DessertsName": self._DessertsName,
			"MenuDesc4": self._MenuDesc4,
			"ExploreMenu4": self._ExploreMenu4,
			"OrderOnline": self._OrderOnline,
			"BookATable": self._BookATable,
			"Image13": self._Image13,
			"AboutUsHead": self._AboutUsHead,
			"AboutUs1": self._AboutUs1,
			"AboutUs2": self._AboutUs2,
			"AboutUs": self._AboutUs,
			"JoinOurTeam": self._JoinOurTeam,
			"VisitUs": self._VisitUs,
			"LocationImage": self._LocationImage,
			"Address": self._Address,
			"PhoneImage": self._PhoneImage,
			"PhoneNo": self._PhoneNo,
			"EmailImage": self._EmailImage,
			"Email": self._Email,
